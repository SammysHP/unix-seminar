...
% \usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows,automata,calc,chains,trees,positioning,scopes,decorations.pathmorphing,shapes,backgrounds,tikzmark,fadings}
...
\makeatletter\newcommand{\insertcode}[5]{
    ...
    \makebox[\linewidth][c]{
        \begin{tikzpicture}[remember picture, inner sep=0pt]
            ...
            \node (code) [right=5mm of overview] {
...
%         \For{jeden Eintrag in mount Tabelle}
%             \If{Gerät schon eingetragen} Fehler \EndIf
%             \If{Noch kein Eintrag reserviert} Reservieren \EndIf
%         \EndFor
%         \If{alles voll} Fehler \EndIf
%         \State Gerät öffnen
